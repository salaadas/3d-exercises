...
int main()
{
    ...
    while (!quit)
    {
        ...
        if (!backgroundTexture.loadFromFile("/home/salaadas/Pictures/wallpaper/anime_girl_holding_cpp.png"))
            return EXIT_FAILURE;
        const sf::Sprite background(backgroundTexture);

        // Create some text to draw on top of our OpenGL object
        sf::Font font;
        if (!font.loadFromFile("/usr/share/fonts/truetype/iosevka/iosevka-bold.ttf"))
            return EXIT_FAILURE;

        sf::Text text("SFML / OpenGL demo", font, 40);
        sf::Text sRgbInstructions("Press space to toggle sRGB conversion", font, 40);
        sf::Text mipmapInstructions("Press return to toggle mipmapping", font, 40);
        text.setFillColor(sf::Color(255, 0, 0, 170));
        sRgbInstructions.setFillColor(sf::Color(255, 0, 0, 170));
        mipmapInstructions.setFillColor(sf::Color(255, 0, 0, 170));
        ...
        sf::Texture texture;
        if (!texture.loadFromFile("/home/salaadas/Pictures/avatars/awesomeface.jpg"))
            return EXIT_FAILURE;
